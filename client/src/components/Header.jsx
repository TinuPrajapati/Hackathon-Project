    ...
    return (
        <header className={`sticky ${scrolled ? "top-[-100%]" : "top-2"} z-10 h-[10vh] w-full flex items-center justify-center transition-all duration-300`}>
            <div className='w-[90%] h-full bg-white/80 backdrop-blur-xl flex items-center justify-between px-3 rounded-full shadow-lg'>
                ...
                <div className="relative flex items-center space-x-4 sm:ml-6">
                    ...
                    <div className="relative">
                        <button type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none" onClick={() => setOpen(!open)}>
                        ...
                        {open && (
                            <div className="absolute right-0 z-10 w-48 mt-2 rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5">
