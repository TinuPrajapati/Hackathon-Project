    ...
    <footer className="bg-[#f5f0ff] mt-10 py-10">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start mb-4">
              <img
                src={logo}
                alt="HackThinking Logo"
                className="w-30 h-12"
              />
              {/* <span className="ml-2 text-2xl font-bold text-[#8b5cf6]">
                Brain Squads
              </span> */}
            </div>
            <p className="text-gray-600">
              Building dream teams with AI-powered matching
            </p>
          </div>

          {/* Social Links */}
          <div className="text-center">
            <h3 className="text-lg font-semibold mb-4 text-[#8b5cf6]">
              Connect With Us
            </h3>
          ...
          {/* Contact Form */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-center md:text-left text-[#8b5cf6]">
              Send us a message
            </h3>
        ...
        <div className="border-t border-gray-300 mt-10 pt-4 text-center text-gray-600">
          <p>&copy; {new Date().getFullYear()} HackThinking. All rights reserved.</p>
          {/* <p>
            <a
              href="#"
